...
let package = Package(
    ...
    targets: [
        .target(
            name: "Web3Core",
            dependencies: [.product(name: "secp256k1", package: "secp256k1.swift"), "BigInt", "CryptoSwift"]
        ),
        .target(
            name: "web3swift",
            dependencies: [.product(name: "secp256k1", package: "secp256k1.swift"), "Web3Core", "BigInt"],
            resources: [
